...
const copy = {
  fr: {
    navSummary: "Synthèse", navDirectory: "Répertoire", navProvinces: "Provinces",
    eyebrow: "Observatoire pancanadien", title: "Politiques et ressources IAG dans les systèmes scolaires", lede: "Une vue comparée des inventaires documentaires du Québec, de l'Ontario et de la Colombie-Britannique.",
    notice: "Les fiches restent attribuées à leur observatoire provincial. « Aucun document public repéré » signifie qu'aucune publication institutionnelle concluante n'a été trouvée lors de la vérification, et non qu'aucune recherche n'a été faite.",
    total: "Organisations scolaires", guardrails: "Avec balises ou politiques IAG", material: "Avec matériel pédagogique IAG", sources: "Liens ou sources consignés",
    comparisonTitle: "Comparaison des provinces", comparisonLede: "Part des organisations ayant un statut Oui ou Partiel dans les inventaires provinciaux.", policy: "Balises ou politiques", resources: "Ressources pédagogiques",
    provincesTitle: "Observatoires provinciaux", provincesLede: "Accédez à la veille détaillée et aux documents sources propres à chaque province.", listed: "organisations", documents: "fiches avec sources", open: "Ouvrir l'observatoire",
    directoryTitle: "Répertoire pancanadien", directoryLede: "Filtrez les organisations recensées dans les trois observatoires.", search: "Rechercher une organisation", allProvinces: "Toutes les provinces", allStatuses: "Tous les statuts", name: "Organisation", province: "Province", type: "Type", guardrail: "Balises", teaching: "Matériel", date: "Dernière vérification", result: "résultat",
    methodologyTitle: "Portée et méthode", sourcesTitle: "Sources et responsabilité", methodOne: "Le registre national est une vue agrégée de trois inventaires provinciaux publiés.", methodTwo: "Les statuts sont ceux des observatoires d'origine; les définitions et la profondeur de recherche peuvent varier.", methodThree: "Le site national n'établit pas de nouvelles conclusions institutionnelles.", sourceOne: "Québec : IAgCSS, centres de services scolaires et commissions scolaires.", sourceTwo: "Ontario : IAgOntario, conseils scolaires.", sourceThree: "Colombie-Britannique : IAgCB, districts scolaires publics.",
    yes: "Oui", partial: "Partiel", no: "Non", unknown: "Aucun document public repéré", source: "Source ou observatoire", lastCheck: "Dernière vérification", close: "Fermer", sourceCount: "Liens ou sources consignés", footer: "Registre national basé sur les observatoires provinciaux.", version: "Version",
  },
  en: {
